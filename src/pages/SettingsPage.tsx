      ...
      <div className="mx-4 rounded-[18px] bg-card overflow-hidden" style={cardStyle}>
        <div className="px-4 py-3.5">
          <div className="flex items-center gap-3 mb-2">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg text-base bg-muted">🧮</span>
          ...
          <p className="text-[11px] text-muted-foreground/60 mb-2 px-0.5">用于计算消费占比，数据仅存储在本地</p>
          {editingIncome ? (
            ...
            >
              {settings.monthlyIncome > 0 ? (
                ...
                <div className="flex items-center">
                  <span className="text-[13px] text-muted-foreground">点击设置，解锁消费占比分析</span>
                  <ChevronRight size={14} className="ml-auto text-muted-foreground/40" />
                </div>
              )}
            </button>
